...
public class SelectLodgingView extends View {
    ...
    public SelectLodgingView(int campId, List<Lodging> sortedLodgings, LodgingDataManager lodgingDataManager) {
        this.campId = campId;
    ...
    public Event render() {
        ...
        System.out.println(TextFormatter.italic("Entrez l'identifiant (#) d'un hébergement pour gérer ses réservations."));
        ...
        try {
            ...
            KinomichiFunctions.promptInputWithCommandHandling(scanner, (_, command) -> {
                ...
                System.out.printf("%s%n", TextFormatter.green(TextFormatter.italic("Hébergement sélectionn�� : ", TextFormatter.bold(selectedLodging.toString()))));
            });
            ...
            if (response instanceof SortColumnCommand sortColumnCommand) {
                return new CallUrlEvent("/camps/manage/%d/lodgings/reservations/select/sort/%s".formatted(this.campId, this.buildSortPathSegment(sortColumnCommand)));
