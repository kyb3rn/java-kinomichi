...
public class SelectDinnerView extends View {
    ...
    public SelectDinnerView(int campId, List<Dinner> sortedDinners, DinnerDataManager dinnerDataManager) {
        this.campId = campId;
    ...
    public Event render() {
        ...
        System.out.println(TextFormatter.italic("Entrez l'identifiant (#) d'un repas pour gérer ses réservations."));
        ...
        try {
            ...
            KinomichiFunctions.promptInputWithCommandHandling(scanner, (_, command) -> {
                ...
                System.out.printf("%s%n", TextFormatter.green(TextFormatter.italic("Repas sélectionné : ", TextFormatter.bold(selectedDinner.toString()))));
            });
            ...
            if (response instanceof SortColumnCommand sortColumnCommand) {
                return new CallUrlEvent("/camps/manage/%d/dinners/reservations/select/sort/%s".formatted(this.campId, this.buildSortPathSegment(sortColumnCommand)));
