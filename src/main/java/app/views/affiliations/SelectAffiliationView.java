...
public class SelectAffiliationView extends View {
    ...
    public SelectAffiliationView(List<Affiliation> sortedAffiliations, AffiliationDataManager affiliationDataManager) {
    ...
    public Event render() {
        ...
        try {
            ...
            if (response instanceof SortColumnCommand sortColumnCommand) {
                return new CallUrlEvent("/affiliations/modify/select/sort/" + this.buildSortPathSegment(sortColumnCommand));
