...
public class SessionTrainer extends IdentifiedModel implements Hydratable<SessionTrainer.Data> {
    ...
    public int getSessionId() throws ModelException {
        if (this.session == null) {
            throw new ModelException("La session de référence du formateur est nulle");
        }
    ...
    public int getPersonId() throws ModelException {
        if (this.person == null) {
            throw new ModelException("La personne de référence du formateur est nulle");
        }
    ...
    public void setSession(Session session) throws ModelException {
        if (session == null) {
            throw new ModelVerificationException("La session de référence d'un formateur ne peut pas être nulle");
        }
    ...
    public void setPerson(Person person) throws ModelException {
        if (person == null) {
            throw new ModelVerificationException("La personne de référence d'un formateur ne peut pas être nulle");
        }
    ...
    public Data dehydrate() throws ModelException {
        return new SessionTrainer.Data(this);
    }
    ...
    public static class Data extends IdentifiedModelData implements CustomSerializable, JsonConvertible {
        ...
        public Data(SessionTrainer sessionTrainer) throws ModelException {
            this.setId(sessionTrainer.getId());
            this.setSessionId(sessionTrainer.getSessionId());
            this.setPersonId(sessionTrainer.getPersonId());
        }
