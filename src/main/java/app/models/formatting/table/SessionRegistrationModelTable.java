...
public class SessionRegistrationModelTable extends IdentifiedModelTable<SessionRegistration> {

    // ─── Constructors ─── //

    public SessionRegistrationModelTable(SessionRegistration sessionRegistration) throws ModelTableException {
